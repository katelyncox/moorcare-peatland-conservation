...
# monitoring_data <- tbl(con, in_catalog("sol_eng_demo_nickp", "moorcare", "synthetic_monitoring_data"))
# restoration_projects <- tbl(con, in_catalog("sol_eng_demo_nickp", "moorcare", "synthetic_restoration_projects"))
